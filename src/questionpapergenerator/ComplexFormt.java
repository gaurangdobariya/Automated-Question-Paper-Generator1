 ...
 * @author ASUS
 */
public class ComplexFormt extends javax.swing.JFrame {
    ...
    public ComplexFormt(String extype,String subj,String sub_code,String t_h,String output) {
        this.extype=extype;
    ...
    private void btnSubmitq3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitq3ActionPerformed
      try {
            ...
            try {
                ...
                Logger.getLogger(ComplexFormt.class.getName()).log(Level.SEVERE, null, ex);
            }
...
int x=Integer.parseInt(txttotq3.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComplexFormt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ComplexFormt().setVisible(true);
            }
        });
    }
